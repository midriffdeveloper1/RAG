...
Revision ID: 7875852c6d79
Revises: 
Create Date: 2026-08-28 09:57:26.264368
...
def upgrade() -> None:
    ...
    sa.Column('unresolved_streak', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f('ix_chat_sessions_needs_human'), 'chat_sessions', ['needs_human'], unique=False)
    op.create_table('faqs',
    sa.Column('id', sa.String(length=16), nullable=False),
    sa.Column('business_id', sa.String(length=16), nullable=False),
    ...
    op.create_index(op.f('ix_holidays_day_of_week'), 'holidays', ['day_of_week'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_holidays_day_of_week'), table_name='holidays')
    op.drop_index(op.f('ix_holidays_date'), table_name='holidays')
    op.drop_table('holidays')
    op.drop_table('faqs')
    op.drop_index(op.f('ix_chat_sessions_needs_human'), table_name='chat_sessions')
