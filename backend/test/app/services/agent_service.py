...
"""Deprecated: the single monolithic agent has been replaced by the
multi-agent system in app/services/agents/ (KnowledgeAgent, BookingAgent,
SupportAgent, orchestrated by OrchestratorService).

This module is kept only so any old import of `AgentService` keeps working;
new code should import OrchestratorService directly from
app.services.agents.orchestrator.
"""
from app.services.agents.orchestrator import OrchestratorService as AgentService  # noqa: F401